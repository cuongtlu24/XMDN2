    ...
    <section id="amenities" className="py-20 bg-primary text-primary-foreground">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="mb-8">
              <h3 className="text-secondary font-bold text-lg mb-2">TIỆN ÍCH NGOẠI KHU</h3>
            ...
            <p className="text-primary-foreground/90 leading-relaxed mb-8">
              Nằm trong khu dân cư hiện hữu, Star Hills Lộc An chính là kết tinh hoàn hảo khi 
              các tiện ích ngoại khu: trường học, ngân hàng, bến xe, khu du lịch, siêu thị, 
              chợ… đều có sẵn và liền kề khu vực, đáp ứng được nhu cầu an cư và đầu tư.
            </p>

            <div className="grid grid-cols-3 gap-4">
              {amenities.map((amenity, index) => (
                <div key={index} className="text-center">
                  <div className="w-16 h-16 bg-primary-foreground/10 rounded-full flex items-center justify-center mx-auto mb-3">
